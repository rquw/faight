module.exports = {
  ...
  WEAPONS: {
    pistol:  { ammo: 12, cd: 0.28, dmg: 20, kb: 4.6, speed: 75,  life: 1.0, spread: 0.015, pellets: 1, recoil: 2.2, auto: false, weight: 22, len: 0.38, rack: 0.3 },
    ar:      { ammo: 30, cd: 0.09, dmg: 9,  kb: 2.6, speed: 85,  life: 1.0, spread: 0.05,  pellets: 1, recoil: 1.2, auto: true,  weight: 20, len: 0.8, twoHand: true, rack: 0.42 },
    ...
    sniper:  { ammo: 4,  cd: 1.3,  dmg: 75, kb: 29,  speed: 170, life: 1.0, spread: 0,     pellets: 1, recoil: 14, auto: false, weight: 10, len: 1.15, twoHand: true, rack: 0.7 },
    ...
    minigun: { ammo: 90, cd: 0.05, dmg: 5,  kb: 1.7, speed: 80,  life: 1.0, spread: 0.12,  pellets: 1, recoil: 1.9, auto: true,  weight: 8,  len: 0.9, twoHand: true, spinup: 0.4, rack: 0.5 },
